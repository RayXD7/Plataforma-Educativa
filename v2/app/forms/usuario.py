...
class ResetPasswordForm(FlaskForm):
    nueva_clave = PasswordField('Nueva contraseña', validators=[InputRequired(), Length(min=6, max=128)])
    confirm_password = PasswordField('Confirmar Contraseña', validators=[
        InputRequired(), EqualTo('clave', message='Las contraseñas deben coincidir.')
    ])
